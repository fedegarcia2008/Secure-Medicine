              ...
              >
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoIcon}>
                    <Ionicons name="repeat-outline" size={20} color={PRIMARY} />
                  </View>

                  <View style={styles.infoTextContainer}>
                    <Text style={styles.infoLabel}>Cada cuánto se toma</Text>
                ...
                <View style={styles.infoRow}>
                  <View style={styles.infoIcon}>
                    <Ionicons name="medical-outline" size={20} color={PRIMARY} />
                  </View>
                ...
                <View style={styles.infoRow}>
                  ...
                  <View style={styles.infoTextContainer}>
                    <Text style={styles.infoLabel}>Límite de dosis</Text>
                    <Text style={styles.infoValue}>
